...
import { MentorSkillsComponent } from 'app/entities/user/mentor-skills/mentor-skills.component';
...
describe('Component Tests', () => {
  describe('MentorSkills Management Component', () => {
    let comp: MentorSkillsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MentorSkillsComponent, '')
        .compileComponents();
